...
// Dev-only: the /norths-devils?edit=1 collage editor POSTs the arranged
// positions here and we write them to content/norths-collage.json.
...
export async function POST(req: Request) {
  ...
  const file = path.join(process.cwd(), "content", "norths-collage.json");
