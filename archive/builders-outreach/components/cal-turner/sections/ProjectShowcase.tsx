...
export interface Project {
  slug: string;
  title: string;
  /** location / status line under the title */
  subtitle: string;
  /** collaborators line, bottom left (builder, photographer, concept) */
  credit?: string;
...
export default function ProjectShowcase({
  ...
  return (
    ...
    >
      ...
      <div ref={imgRef} className="absolute inset-0 -top-[12%] h-[124%] will-change-transform">
        {project.images.map((src, i) => (
          ...
          >
            <Image
              src={src}
              alt={i === 0 ? `${project.title}, Cal Turner Architects` : ""}
              fill
      ...
      {/* Bottom-left soft radial glow — keeps the credit line legible */}
      {project.credit && (
        <div
      ...
      <div ref={layerRef} className="absolute inset-0 will-change-transform pointer-events-none">
        ...
        {/* Credits — bottom left (collaborators, no label) */}
        {project.credit && (
          <div className="absolute bottom-6 left-5 md:bottom-8 md:left-8 max-w-[75%]">
