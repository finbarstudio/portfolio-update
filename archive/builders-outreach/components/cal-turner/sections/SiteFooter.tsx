    ...
    <footer className="lf" aria-label="Footer" ref={footerRef}>
      ...
      <div className="lf-info">
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">Cal Turner Architects</span>
              <span className="lf-value">Residential Architecture</span>
              <span className="lf-value">Brisbane &amp; Southeast Queensland</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">The promise</span>
              <span className="lf-value">Architecture that starts with you</span>
              <span className="lf-value">No graduates, no handoffs</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <a href="tel:+61431691074" className="lf-value lf-link tabular-nums">
                0431 691 074
              </a>
              <a href="mailto:mail@calturnerarchitects.com.au" className="lf-value lf-link">
                mail@calturnerarchitects.com.au
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col lf-col-end">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-value">© {year} Cal Turner Architects</span>
              <span className="lf-label">Registered Architect · M.Arch UQ</span>
      ...
      <div className="lf-mark" aria-label="Cal Turner Architects">
