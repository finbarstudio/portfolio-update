...
const RIGHT = [
  { label: "Contact", href: "mailto:mail@calturnerarchitects.com.au" },
];
...
export default function Nav({
  ...
  useEffect(() => {
    ...
    window.addEventListener("cal-turner:intro-done", reveal);
    window.addEventListener("scroll", onScroll, { passive: true });
    const fallback = window.setTimeout(reveal, 5500);
    function cleanup() {
      window.removeEventListener("cal-turner:intro-done", reveal);
