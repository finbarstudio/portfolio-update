...
/**
 * Toggles html.arl-nav-dark while the nav line sits over a dark section
...
export default function NavTone() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      document.documentElement.classList.toggle("arl-nav-dark", onDark);
    };
    const onScroll = () => {
    ...
    return () => {
      ...
      document.documentElement.classList.remove("arl-nav-dark");
    };
  }, [pathname]);
  return null;
}
