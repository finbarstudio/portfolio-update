    ...
    <footer className="lf" aria-label="Footer" ref={footerRef}>
      ...
      <div className="lf-info">
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">GTO Building</span>
              <span className="lf-value">Award-Winning Sunshine Coast Builder</span>
              <span className="lf-value">Architect-Designed Homes</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <span className="lf-value">Sunshine Coast &amp; Noosa</span>
              <span className="lf-value">Peregian Beach, QLD</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <a href="tel:+61431087344" className="lf-value lf-link tabular-nums">
                0431 087 344
              </a>
              <a href="mailto:info@gtobuilding.com.au" className="lf-value lf-link">
                info@gtobuilding.com.au
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col lf-col-end">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-value">© {year} GTO Building</span>
              <span className="lf-label">QBCC No. 15057360</span>
      ...
      <div className="lf-mark" aria-label="GTO Building">
