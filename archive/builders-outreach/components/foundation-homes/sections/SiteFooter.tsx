    ...
    <footer className="lf" aria-label="Footer" ref={footerRef}>
      ...
      <div className="lf-info">
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">Foundation Homes</span>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <span className="lf-value">Sunshine Coast &amp; Hinterland</span>
              <span className="lf-value">Noosa, QLD</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <a href="tel:+61427140882" className="lf-value lf-link tabular-nums">
                0427 140 882
              </a>
              <a href="mailto:info@foundationhomes.com.au" className="lf-value lf-link">
                info@foundationhomes.com.au
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col lf-col-end">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-value">© {year} Foundation Homes</span>
              <span className="lf-label">QBCC No. 15095686</span>
      ...
      <div className="lf-mark" aria-label="Foundation Homes">
