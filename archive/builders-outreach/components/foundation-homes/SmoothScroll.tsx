...
export default function SmoothScroll({
  ...
  useEffect(() => {
    ...
    if (pathname === "/foundation-homes/site") {
      lenis.stop();
      window.addEventListener("foundation-homes:intro-done", unlock);
    } else {
    ...
    return () => {
      window.removeEventListener("foundation-homes:intro-done", unlock);
