    ...
    <footer className="lf" aria-label="Footer" ref={footerRef}>
      ...
      <div className="lf-info">
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">HM Developments</span>
              <span className="lf-value">Luxury Sunshine Coast Developer</span>
              <span className="lf-value">Residential · Commercial</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <span className="lf-value">1/51 Minchinton Street</span>
              <span className="lf-value">Caloundra, QLD 4551</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <a href="tel:+61752130682" className="lf-value lf-link tabular-nums">
                (07) 5213 0682
              </a>
              <a href="mailto:info@hmdevelopments.com.au" className="lf-value lf-link">
                info@hmdevelopments.com.au
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col lf-col-end">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-value">© {year} HM Developments</span>
              <span className="lf-label">UDIA · MBA · HIA Member</span>
      ...
      <div className="lf-mark" aria-label="HM Developments">
