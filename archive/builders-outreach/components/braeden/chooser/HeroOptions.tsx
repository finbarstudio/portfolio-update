...
// Lindon-style awards strip for the (chosen) hero — real, faithful decorations.
const HERO1_AWARDS = ["Est. 1996", "5× House of the Year", "National Master Builder of the Year"];
...
export default function HeroOptions() {
  return (
    <>
      {/* 1 — Full-bleed drift (Finbar's pick): a lighter daylight build, the bold
          Montserrat wordmark treatment for the statement, no eyebrow, and a
          Lindon-style awards strip. Imagery leads; the decorations do the talking. */}
      <section className="brd-opt" style={{ position: "relative", minHeight: "100svh", overflow: "hidden", background: "#2b2b2e", display: "grid", placeItems: "center" }}>
        <Tag n={1} label="Full-bleed drift" />
        <Photo src={`${P}/peregian.webp`} pos="center 54%" />
