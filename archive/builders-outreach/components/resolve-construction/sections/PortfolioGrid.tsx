...
const CATEGORIES = ["Custom homes", "Waterfront", "Award winners"];

// Real Resolve Construction projects (award-winning).
const PROJECTS: Item[] = [
  { slug: "neu-burleigh", title: "Neu Burleigh", location: "Burleigh Waters", award: "24", categories: ["Custom homes", "Waterfront", "Award winners"] },
  { slug: "villa-franco", title: "Villa Franco", location: "Broadbeach Waters", award: "25", categories: ["Custom homes", "Waterfront", "Award winners"] },
  { slug: "sovereign-house", title: "The Sovereign House", location: "Coomera Waters", award: "22", categories: ["Custom homes", "Waterfront", "Award winners"] },
  { slug: "serenity-shores", title: "Serenity Shores", location: "Helensvale", award: "20", categories: ["Custom homes", "Award winners"] },
  { slug: "montego-hills", title: "Montego Hills", location: "Ormeau", award: "21", categories: ["Custom homes", "Award winners"] },
  { slug: "lowry-farmhouse", title: "The Lowry Farmhouse", location: "Neranwood", award: "25", categories: ["Custom homes", "Award winners"] },
];
...
function GridTile({ p, eager }: { p: Item; eager: boolean }) {
  ...
  return (
    ...
    >
      ...
      />
      <Image
        src={`/resolve-construction/projects/${p.slug}.webp`}
        alt={`${p.title}, Resolve Construction`}
        fill
        quality={82}
        priority={eager}
