    ...
    <footer className="lf" aria-label="Footer" ref={footerRef}>
      ...
      <div className="lf-info">
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">Resolve Construction</span>
              <span className="lf-value">Award-Winning Gold Coast Builder</span>
              <span className="lf-value">Prestige Custom Homes</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">Service area</span>
              <span className="lf-value">Gold Coast &amp; Hinterland</span>
              <span className="lf-value">Licensed QLD &amp; NSW</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <a href="tel:+61755736194" className="lf-value lf-link tabular-nums">
                (07) 5573 6194
              </a>
              <a href="mailto:admin@resolveconstruction.net.au" className="lf-value lf-link">
                admin@resolveconstruction.net.au
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col lf-col-end">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-value">© {year} Resolve Construction</span>
              <span className="lf-label">QBCC No. 15262357</span>
      ...
      <div className="lf-mark" aria-label="Resolve Construction">
