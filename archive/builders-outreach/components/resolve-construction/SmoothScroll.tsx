...
export default function SmoothScroll({
  ...
  useEffect(() => {
    ...
    if (pathname === "/resolve-construction/site") {
      lenis.stop();
      window.addEventListener("resolve-construction:intro-done", unlock);
    } else {
    ...
    return () => {
      window.removeEventListener("resolve-construction:intro-done", unlock);
