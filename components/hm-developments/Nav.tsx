...
const LEFT = [
  { label: "Residential", href: "/hm-developments/site/portfolio" },
...
export default function Nav({
  ...
  useEffect(() => {
    ...
    window.addEventListener("hm-developments:intro-done", reveal);
    window.addEventListener("scroll", onScroll, { passive: true });
    const fallback = window.setTimeout(reveal, 5500);
    function cleanup() {
      window.removeEventListener("hm-developments:intro-done", reveal);
