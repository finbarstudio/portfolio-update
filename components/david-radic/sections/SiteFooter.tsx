    ...
    <footer className="lf" aria-label="Footer" ref={footerRef}>
      ...
      <div className="lf-info">
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">David Radic Prestige Homes</span>
              <span className="lf-value">Gold Coast Prestige Builder</span>
              <span className="lf-value">Waterfront &amp; Island Homes</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <span className="lf-value">The Gold Coast</span>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <a href="tel:+61402996715" className="lf-value lf-link tabular-nums">
                0402 996 715
              </a>
              <a href="mailto:admin@drphomes.com.au" className="lf-value lf-link">
                admin@drphomes.com.au
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col lf-col-end">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-value">© {year} David Radic Prestige Homes</span>
              <span className="lf-label">QBCC No. 1065291</span>
      ...
      <div className="lf-mark" aria-label="David Radic Prestige Homes">
