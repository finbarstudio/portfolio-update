...
import ProjectLaurel from "@/components/gto-building/ProjectLaurel";
...
const CATEGORIES = ["New builds", "Renovations", "Architect-designed"];

// Real GTO Building projects.
const PROJECTS: Item[] = [
  { slug: "panorama", title: "Panorama House", location: "Doonan", categories: ["New builds", "Architect-designed"] },
  { slug: "tristania", title: "Tristania Beach House", location: "Marcus Beach", categories: ["New builds", "Architect-designed"] },
  { slug: "tallgum", title: "Tallgum House", location: "Doonan", categories: ["New builds", "Architect-designed"] },
  { slug: "newbuilds", title: "New Build", location: "Sunshine Coast", categories: ["New builds"] },
  { slug: "renovations", title: "Coastal Renovation", location: "Sunshine Coast", categories: ["Renovations"] },
];
...
function GridTile({ p, eager }: { p: Item; eager: boolean }) {
  ...
  return (
    ...
    >
      ...
      />
      <Image
        src={`/gto-building/projects/${p.slug}.webp`}
        alt={`${p.title}, GTO Building`}
        fill
        quality={82}
        priority={eager}
