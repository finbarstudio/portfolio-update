 ...
 * the capability statement, and ongoing social/editorial content. Each gets its
 * own numbered section with an editorial header.
 */
    ...
    <div className="kinaya-showcase">
      ...
      <section className="kinaya-section">
        ...
        <p className="packer-section-body">
          Across the contract I ran and maintained the Packer &amp; Associates
          website end to end — content updates, new pages, layout work and ongoing
          upkeep — keeping the site current and on-brand as the business evolved.
        </p>
      ...
      <section className="kinaya-section">
        ...
        <p className="packer-section-body">
          ...
          written, designed and produced from the ground up, built to present the
          company&apos;s services with clarity and polish.
        </p>
        <div className="packer-pdf">
          <PDFSlideshow title="Capability Statement" pages={PDF_PAGES} />
        </div>
      </section>
      ...
      <section className="kinaya-section">
        ...
        <p className="packer-section-body">
          Ongoing content across the company blog and LinkedIn — writing and
          designing posts to keep the brand active, consistent and visible to its
          audience throughout the engagement.
        </p>
