...
const LEFT = [
  { label: "Apartments", href: "/mbc-prestige/site/portfolio" },
  { label: "Land Releases", href: "#" },
...
export default function Nav({
  ...
  useEffect(() => {
    ...
    window.addEventListener("mbc-prestige:intro-done", reveal);
    window.addEventListener("scroll", onScroll, { passive: true });
    const fallback = window.setTimeout(reveal, 5500);
    function cleanup() {
      window.removeEventListener("mbc-prestige:intro-done", reveal);
