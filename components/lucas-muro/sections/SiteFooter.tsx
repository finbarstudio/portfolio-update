 ...
 * the bottom, then a giant LUCAS MURO wordmark fitted across the bottom within
    ...
    <footer className="lf" aria-label="Footer" ref={footerRef}>
      ...
      <div className="lf-info">
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">Lucas Muro</span>
              <span className="lf-value">Architectural &amp; Interiors Photographer</span>
              <span className="lf-value">Marcoola, Sunshine Coast</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">The approach</span>
              <span className="lf-value">It&rsquo;s all about light, shape and texture</span>
              <span className="lf-value">Shooting QLD, NSW &amp; VIC</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <a href="tel:+61424089770" className="lf-value lf-link tabular-nums">
                +61 424 089 770
              </a>
              <a href="mailto:info@lucasmuro.com.au" className="lf-value lf-link">
                info@lucasmuro.com.au
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col lf-col-end">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-value">© {year} Lucas Muro Photographer</span>
              <span className="lf-label">Shooting since 2004</span>
      ...
      <div className="lf-mark" aria-label="Lucas Muro">
