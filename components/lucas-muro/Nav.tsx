...
const LEFT = [
  { label: "Latest Work", href: "/lucas-muro/site/work" },
  { label: "About", href: "/lucas-muro/site/about" },
];
const RIGHT = [
  { label: "Contact", href: "mailto:info@lucasmuro.com.au" },
];
...
export default function Nav({
  ...
  useEffect(() => {
    ...
    window.addEventListener("lucas-muro:intro-done", reveal);
    window.addEventListener("scroll", onScroll, { passive: true });
    const fallback = window.setTimeout(reveal, 5500);
    function cleanup() {
      window.removeEventListener("lucas-muro:intro-done", reveal);
