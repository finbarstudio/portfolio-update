  ...
  return (
    ...
    >
      <label className="block sm:col-span-1">
        ...
        <input name="name" required autoComplete="name" className={`arl-input ${field}`} />
      </label>
      <label className="block sm:col-span-1">
        <span className="eyebrow block" style={{ marginBottom: 8 }}>Email</span>
        <input name="email" type="email" required autoComplete="email" className={`arl-input ${field}`} />
      </label>
      <label className="block sm:col-span-1">
        <span className="eyebrow block" style={{ marginBottom: 8 }}>Phone</span>
        <input name="phone" type="tel" autoComplete="tel" className={`arl-input ${field}`} />
      </label>
      <label className="block sm:col-span-1">
        <span className="eyebrow block" style={{ marginBottom: 8 }}>Suburb / Site</span>
        <input name="suburb" className={`arl-input ${field}`} />
      </label>
      <label className="block sm:col-span-2">
        <span className="eyebrow block" style={{ marginBottom: 8 }}>Tell us about your project</span>
        <textarea name="message" rows={3} className={`arl-input ${field} resize-none`} />
      </label>
      <div className="sm:col-span-2" style={{ marginTop: "clamp(8px,1vw,16px)" }}>
        <button type="submit" className="arl-btn" data-cursor="Send">
