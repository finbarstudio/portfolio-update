...
export default function Hero() {
  return (
    <section data-tone="dark" className="relative w-full" style={{ height: "100svh", minHeight: 560 }}>
      ...
      <div className="absolute inset-0 frame flex flex-col justify-end" style={{ paddingBottom: "clamp(48px,9vh,120px)", color: "var(--paper)" }}>
        <div className="wrap w-full">
          <p className="eyebrow" style={{ color: "rgba(244,241,234,0.86)" }}>
            Fourth-generation Sunshine Coast builders
          </p>
          <h1 className="display" style={{ color: "var(--paper)", fontSize: "clamp(38px, 6vw, 98px)", marginTop: "clamp(18px,2vw,30px)", maxWidth: "13ch" }}>
