...
const LEFT = [
  ...
  { label: "Why Choose Lindon", href: "#" },
  { label: "About Us", href: "/lindon/site/about" },
];
const RIGHT = [
...
export default function Nav({
  ...
  useEffect(() => {
    ...
    window.addEventListener("lindon:intro-done", reveal);
    window.addEventListener("scroll", onScroll, { passive: true });
    const fallback = window.setTimeout(reveal, 5500);
    function cleanup() {
      window.removeEventListener("lindon:intro-done", reveal);
