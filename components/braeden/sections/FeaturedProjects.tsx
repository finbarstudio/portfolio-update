...
const PROJECTS: P[] = [
  { title: "Lake House", meta: "Custom Home · Sunshine Coast", src: "/braeden/projects/lake-house.webp" },
  { title: "MacPhee Residence", meta: "Custom Home · Buderim", src: "/braeden/projects/macphee.webp" },
  { title: "Watson Residence", meta: "Custom Home", src: "/braeden/projects/watson.webp" },
  { title: "KI House", meta: "Custom Home", src: "/braeden/projects/ki-house.webp" },
  { title: "Curra's Annex", meta: "Secondary Dwelling", src: "/braeden/projects/curras.webp" },
];
      ...
      <div ref={layerRef} className="absolute inset-0 frame pointer-events-none" style={{ willChange: "transform" }}>
        <div className="wrap relative h-full">
          ...
          <div className="absolute right-0 bottom-[clamp(32px,6vh,72px)] text-right pointer-events-auto">
            <a href="/braeden/site/projects" data-cursor="All Work" className="eyebrow" style={{ color: "var(--paper)", borderBottom: "1px solid rgba(244,241,234,0.4)", paddingBottom: 3, display: "inline-block" }}>
              View all projects
            </a>
          </div>
        </div>
