...
import AwardIcon from "@/components/resolve-construction/AwardIcon";

gsap.registerPlugin(ScrollTrigger);

// Real Master Builders Queensland awards (Gold Coast & QLD State).
const AWARDS = [
  { mark: "24", body: "MBA", status: "Winner", label: "Individual Home $2–3M" },
  { mark: "25", body: "MBA", status: "Winner", label: "Individual Home $1.25–2M" },
  { mark: "25", body: "MBA", status: "Winner", label: "QLD Individual Home $2–2.5M" },
  { mark: "25", body: "MBA", status: "Winner", label: "Best Use of Sloping Sites" },
  { mark: "22", body: "MBA", status: "Winner", label: "Custom Home $750–950K" },
  { mark: "20", body: "MBA", status: "Winner", label: "Custom Home $750–950K" },
];
...
export default function HomeHeader() {
  ...
  useEffect(() => {
    ...
    const t = gsap.delayedCall(introTotal, () => {
      window.dispatchEvent(new Event("resolve-construction:intro-done"));
    });
  ...
  return (
    ...
    >
      <div ref={contentRef} className="flex flex-col items-center will-change-transform w-full">
        <div ref={logoRef} className="w-[clamp(230px,32vw,400px)]">
          <Image
            src="/resolve-construction/logo.png"
