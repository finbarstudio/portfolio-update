    ...
    <footer className="lf" aria-label="Footer" ref={footerRef}>
      ...
      <div className="lf-info">
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">BPPD</span>
              <span className="lf-value">Brisbane Prestige Property Developments</span>
              <span className="lf-value">Development · Investment · Management</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">Office</span>
              <span className="lf-value">Suite 107, 640 Oxley Road</span>
              <span className="lf-value">Corinda, QLD 4075</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <a href="tel:+61738917222" className="lf-value lf-link tabular-nums">
                (07) 3891 7222
              </a>
              <a href="mailto:john@bppd.com.au" className="lf-value lf-link">
                john@bppd.com.au
              </a>
            </div>
          </div>
        ...
        <div className="lf-col lf-col-end">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-value">© {year} Brisbane Prestige Property Developments</span>
              <span className="lf-label">South East Queensland</span>
      ...
      <div className="lf-mark" aria-label="BPPD">
