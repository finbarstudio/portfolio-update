    ...
    <footer className="lf" aria-label="Footer" ref={footerRef}>
      ...
      <div className="lf-info">
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-label">Ross Hogno Constructions</span>
              <span className="lf-value">Award-Winning Toowoomba Builder</span>
              <span className="lf-value">Established 2005</span>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <span className="lf-value">Toowoomba &amp; the Darling Downs</span>
        ...
        <div className="lf-col">
          <div className="lf-mask">
            <div className="lf-reveal">
              ...
              <a href="tel:+61437525613" className="lf-value lf-link tabular-nums">
                0437 525 613
              </a>
              <a href="mailto:enquiries@rosshogno.com.au" className="lf-value lf-link">
                enquiries@rosshogno.com.au
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="lf-col lf-col-end">
          <div className="lf-mask">
            <div className="lf-reveal">
              <span className="lf-value">© {year} Ross Hogno Constructions</span>
              <span className="lf-label">QBCC No. 1265113</span>
      ...
      <div className="lf-mark" aria-label="Ross Hogno Constructions">
