...
export const collageMeta: Record<string, CollageMeta> = {
  ...
  trumperdrive: { src: d("trumperdrive"), alt: "Victor Trumper driving (Beldam photograph)" },
  grace: { src: d("grace"), alt: "W.G. Grace at the crease" },
  gracespy: { src: d("gracespy"), alt: "W.G. Grace, Vanity Fair caricature, 1877" },
  lordhawke: { src: d("lordhawke"), alt: "Lord Hawke, Vanity Fair caricature" },
  darling: { src: d("darling"), alt: "Joe Darling, Australian captain, about 1905" },
  ranji: { src: d("ranji"), alt: "Ranjitsinhji driving" },
  bradmanbat: { src: d("bradmanbat"), alt: "Don Bradman seated with his signature bat" },
  snidercard: { src: d("snidercard"), alt: "Sniders & Abrahams cigarette card of Victor Trumper" },
