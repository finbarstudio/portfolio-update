...
// Private pitch page for David Radic Prestige Homes. Reachable by URL, kept out
// of the index, the sitemap and the public nav.
export const metadata: Metadata = {
  title: { absolute: "For David Radic Prestige Homes · Finbar Studio" },
  description:
    "A note and a working demo for David Radic Prestige Homes, from Brisbane designer Finbar Skitini.",
  robots: { index: false, follow: false },
  alternates: { canonical: undefined },
};

const DEMO_HREF = "/david-radic/site";

const STATS = [
  {
    value: "$2M+",
    label: "Homes, hidden",
    note: "HIA-recognised work in the over-two-million bracket, sitting behind a website built back around 2016.",
  },
  {
    value: "2016",
    label: "Frozen since",
    note: "Most of the site dates to 2016 and still shows the old 'QBSA' licence term that was retired over a decade ago. The homes have moved well past it.",
  },
];
...
export default function DavidRadicPitchPage() {
  return (
    <div className="px-5 md:px-10 pb-10">
      ...
      <section className="pt-[5svh] md:pt-[7svh] pb-16 md:pb-24" aria-label="Introduction">
        <Reveal as="p" immediate className="mono-label text-pink mb-6">
          For David Radic Prestige Homes
        </Reveal>
        <MaskReveal as="h1" className="home-display">
          The homes are prestige. The website is from 2016.
        </MaskReveal>
      ...
      <Reveal as="section" section className="home-section py-24 md:py-36 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-5" aria-label="Why I reached out">
        <div className="md:col-span-5">
          <h2 className="home-display-sm">The homes are prestige. The site doesn&rsquo;t show it.</h2>
        </div>
        <div className="md:col-span-7">
          <p className="text-ink" style={{ fontSize: "clamp(1.05rem, 1.5vw, 1.35rem)", lineHeight: 1.55 }}>
            I went looking at the best builders on the Gold Coast and David Radic kept stopping me.
            Waterfront and island homes, the Buccaneer Residence, an HIA finalist over two million.
            Then I opened the website and felt the drop. It&rsquo;s a 2016 template where your homes
            should be filling the screen. For a builder at your level that&rsquo;s backwards. People
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-6 mt-12">
          <div className="md:col-span-8 flex md:items-center">
            <p className="text-ink" style={{ fontSize: "clamp(1.15rem, 1.9vw, 1.6rem)", lineHeight: 1.4 }}>
              You&rsquo;re winning the recognition and the referrals. The website is where that momentum
              leaks out the back.
            </p>
          </div>
      ...
      <Reveal as="section" section className="home-section py-24 md:py-36 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-5" aria-label="The demo">
        ...
        <div className="md:col-span-7">
          <p className="text-ink" style={{ fontSize: "clamp(1.05rem, 1.5vw, 1.35rem)", lineHeight: 1.55 }}>
            ...
            gallery of your homes you can get lost scrolling, and an about page with room for the family
          ...
          <div className="lindon-demo-card mt-8">
            <div className="flex flex-wrap gap-2 mb-5">
              ...
              <span className="tag tag-default">Our Homes</span>
            ...
            <p className="text-ink-soft mt-5" style={{ fontSize: "0.95rem", lineHeight: 1.5 }}>
              ...
              is there, but only Home, Our Homes and About are built so far, so those are the links that
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
          <div className="border-t border-line pt-5">
            ...
            <p className="text-ink-soft" style={{ fontSize: "clamp(1rem, 1.4vw, 1.2rem)", lineHeight: 1.55 }}>
              You&rsquo;ve got beautiful waterfront photography and a real point of difference, the
              hands-on, husband-and-wife, low-volume approach. That&rsquo;s the kind of thing you weave
              through a whole site, not bury on an about page. I can already picture it, and I&rsquo;d love
              the chance to tell it properly.
            </p>
          </div>
          <div className="border-t border-line pt-5">
            <h3 className="mono-heading text-ink mb-3">The logo</h3>
            <p className="text-ink-soft" style={{ fontSize: "clamp(1rem, 1.4vw, 1.2rem)", lineHeight: 1.55 }}>
              I&rsquo;ve kept your mark on the demo so it still feels like you, but it&rsquo;s a small,
              dated file that could be redrawn crisp and modern. A rebrand isn&rsquo;t essential, but
              the brand would thank you for it, and it&rsquo;s the kind of work I love.
            </p>
          </div>
        </div>
      </Reveal>
