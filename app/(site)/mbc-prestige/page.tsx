...
// Private pitch page for MBC Prestige. Reachable by URL, kept out of the index,
// the sitemap and the public nav.
export const metadata: Metadata = {
  title: { absolute: "For MBC Prestige · Finbar Studio" },
  description:
    "A note and a working demo for MBC Prestige, from Brisbane designer Finbar Skitini.",
  robots: { index: false, follow: false },
  alternates: { canonical: undefined },
};

const DEMO_HREF = "/mbc-prestige/site";

const STATS = [
  {
    value: "2015",
    label: "Running WordPress from",
    note: "The site is on a 2015 WordPress build over an insecure connection, with the real project detail still trapped in downloadable PDFs.",
  },
  {
    value: "40 yrs",
    label: "Hidden heritage",
    note: "Four decades shaping Sunshine Beach, and you'd barely know it from the site. That story should be leading, not buried.",
  },
];
...
const OFFERINGS = [
  ...
  {
    title: "Brand & system",
    body: "Your MBC mark and restrained palette are lovely. I'd build a crisp, consistent system around them, as much or as little as you want.",
  },
];

export default function MbcPitchPage() {
  return (
    <div className="px-5 md:px-10 pb-10">
      ...
      <section className="pt-[5svh] md:pt-[7svh] pb-16 md:pb-24" aria-label="Introduction">
        ...
        <MaskReveal as="h1" className="home-display">
          You know Noosa better than anyone. The website doesn&rsquo;t show it.
        </MaskReveal>
      ...
      <Reveal as="section" section className="home-section py-24 md:py-36 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-5" aria-label="Why I reached out">
        <div className="md:col-span-5">
          <h2 className="home-display-sm">The developments are prestige. The site is from 2015.</h2>
        </div>
        <div className="md:col-span-7">
          <p className="text-ink" style={{ fontSize: "clamp(1.05rem, 1.5vw, 1.35rem)", lineHeight: 1.55 }}>
            I went looking at the developers shaping Noosa and MBC kept stopping me. Forty years on the
            coast, the Kalani riverfront residences, whole-floor apartments in Sunshine Beach. Then I
            opened the website and felt the drop. It&rsquo;s a 2015 WordPress build with the detail
            hidden in PDFs, where your homes should be filling the screen. For a developer at your level
            that&rsquo;s backwards. People should fall for the work the second they land.
          </p>
        </div>
      </Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-6 mt-12">
          <div className="md:col-span-8 flex md:items-center">
            <p className="text-ink" style={{ fontSize: "clamp(1.15rem, 1.9vw, 1.6rem)", lineHeight: 1.4 }}>
              You&rsquo;re selling out boutique releases on reputation. The website is where that
      ...
      <Reveal as="section" section className="home-section py-24 md:py-36 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-5" aria-label="The demo">
        ...
        <div className="md:col-span-7">
          <p className="text-ink" style={{ fontSize: "clamp(1.05rem, 1.5vw, 1.35rem)", lineHeight: 1.55 }}>
            ...
            projects gallery you can get lost scrolling, and an about page with room for the forty-year
            story. Every line is written from scratch, custom code, no template, and it keeps your
            restrained palette and MBC mark. This is one version. A developer like you could go a dozen
            directions.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
          <div className="border-t border-line pt-5">
            ...
            <p className="text-ink-soft" style={{ fontSize: "clamp(1rem, 1.4vw, 1.2rem)", lineHeight: 1.55 }}>
              Forty years shaping Sunshine Beach, a long partnership with Stephen Kidd, boutique
              riverfront addresses, that&rsquo;s a genuinely rare story. It&rsquo;s the kind of thing you
              weave through a whole site, and pull out of the PDFs onto the page. I can already picture
              it.
            </p>
          </div>
          <div className="border-t border-line pt-5">
            ...
            <p className="text-ink-soft" style={{ fontSize: "clamp(1rem, 1.4vw, 1.2rem)", lineHeight: 1.55 }}>
              Your MBC monogram and restrained warm palette are lovely, so I&rsquo;ve kept them and
              built the demo around them. The opportunity isn&rsquo;t a rebrand, it&rsquo;s a sharper,
              modern system and a crisp vector mark, and that&rsquo;s the kind of work I love.
            </p>
          </div>
        </div>
      </Reveal>
