...
// Private pitch page for Ross Hogno Constructions. Reachable by URL, kept out of
// the index, the sitemap and the public nav.
export const metadata: Metadata = {
  title: { absolute: "For Ross Hogno Constructions · Finbar Studio" },
  description:
    "A note and a working demo for Ross Hogno Constructions, from Brisbane designer Finbar Skitini.",
  robots: { index: false, follow: false },
  alternates: { canonical: undefined },
};

const DEMO_HREF = "/ross-hogno/site";

const STATS = [
  {
    value: "11",
    label: "Awards, barely shown",
    note: "Eleven Master Builders awards over two decades, plus a 25-year membership. You'd struggle to find them on the current site.",
  },
  {
    value: "20+",
    label: "Years on the Downs",
    note: "Two decades of award-winning custom homes, let down by a dated slider-template site that doesn't do the work justice.",
  },
];
...
const OFFERINGS = [
  ...
  {
    title: "Headless CMS",
    body: "You run your own content. Add a new build, swap photos and words yourself, no developer, no waiting.",
  },
  {
    title: "SEO",
...
export default function RossHognoPitchPage() {
  return (
    <div className="px-5 md:px-10 pb-10">
      ...
      <section className="pt-[5svh] md:pt-[7svh] pb-16 md:pb-24" aria-label="Introduction">
        <Reveal as="p" immediate className="mono-label text-pink mb-6">
          For Ross Hogno Constructions
        </Reveal>
        <MaskReveal as="h1" className="home-display">
          Ross Hogno builds award-winning homes. The website is a decade behind.
        </MaskReveal>
      ...
      <Reveal as="section" section className="home-section py-24 md:py-36 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-5" aria-label="Why I reached out">
        ...
        <div className="md:col-span-7">
          <p className="text-ink" style={{ fontSize: "clamp(1.05rem, 1.5vw, 1.35rem)", lineHeight: 1.55 }}>
            I went looking at the best builders on the Darling Downs and Ross Hogno kept stopping me.
            Twenty years of custom homes, eleven Master Builders awards, sloping-site and sustainable
            specialists. Then I opened the website and felt the drop. It&rsquo;s an old slider template
            where your homes should be filling the screen. For a builder at your level that&rsquo;s
      ...
      <Reveal as="section" section className="home-section py-24 md:py-36 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-5" aria-label="The demo">
        ...
        <div className="md:col-span-7">
          <p className="text-ink" style={{ fontSize: "clamp(1.05rem, 1.5vw, 1.35rem)", lineHeight: 1.55 }}>
            ...
            projects gallery you can get lost scrolling, and an about page with room for your story.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
          <div className="border-t border-line pt-5">
            ...
            <p className="text-ink-soft" style={{ fontSize: "clamp(1rem, 1.4vw, 1.2rem)", lineHeight: 1.55 }}>
              You&rsquo;ve got two decades of work and a real point of difference, the hands-on,
              detail-led, sustainable approach. That&rsquo;s the kind of thing you weave through a whole
          ...
          <div className="border-t border-line pt-5">
            ...
            <p className="text-ink-soft" style={{ fontSize: "clamp(1rem, 1.4vw, 1.2rem)", lineHeight: 1.55 }}>
              I&rsquo;ve set your name cleanly in the demo, but the brand could do with a crisp, modern
              mark drawn as a proper vector. A rebrand isn&rsquo;t essential, but the brand would thank
              you for it, and it&rsquo;s the kind of work I love.
            </p>
          </div>
        </div>
      </Reveal>
