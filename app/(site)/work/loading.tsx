...
export default function WorkLoading() {
  return (
    <div aria-busy="true" aria-label="Loading work">
      ...
      {/* Card grid — mirrors the real grid (sm:640 breakpoint, 60vh card height,
          14px radius) so there's no column flip or height re-flow when the page
          streams in. */}
        ...
        <div className="grid grid-cols-12 gap-x-8 gap-y-16 md:gap-y-20">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="col-span-12 sm:col-span-6">
              <div className="skeleton" style={{ width: "100%", height: "60vh", borderRadius: 14 }} />
