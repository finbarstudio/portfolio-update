...
// Private pitch page for Resolve Construction. Reachable by URL, kept out of the
// index, the sitemap and the public nav.
export const metadata: Metadata = {
  title: { absolute: "For Resolve Construction · Finbar Studio" },
  description:
    "A note and a working demo for Resolve Construction, from Brisbane designer Finbar Skitini.",
  robots: { index: false, follow: false },
  alternates: { canonical: undefined },
};

const DEMO_HREF = "/resolve-construction/site";

const STATS = [
  {
    value: "11",
    label: "Wins, hard to find",
    note: "Eleven Master Builders wins, five of them in 2025 alone. You'd struggle to find them on the current site.",
  },
  {
    value: "2014",
    label: "Built like it's",
    note: "Static HTML pages, an image standing in for a logo, one webfont and no real mobile layout. The homes are current. The site isn't.",
  },
];
...
const OFFERINGS = [
  ...
  {
    title: "Headless CMS",
    body: "You run your own content. Add a new award-winner, swap photos and words yourself, no developer, no waiting.",
  },
  {
    title: "SEO",
...
export default function ResolvePitchPage() {
  return (
    <div className="px-5 md:px-10 pb-10">
      ...
      <section className="pt-[5svh] md:pt-[7svh] pb-16 md:pb-24" aria-label="Introduction">
        <Reveal as="p" immediate className="mono-label text-pink mb-6">
          For Resolve Construction
        </Reveal>
        <MaskReveal as="h1" className="home-display">
          Resolve builds award-winning homes. The website doesn&rsquo;t keep up.
        </MaskReveal>
      ...
      <Reveal as="section" section className="home-section py-24 md:py-36 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-5" aria-label="Why I reached out">
        <div className="md:col-span-5">
          <h2 className="home-display-sm">The homes win awards. The site is from another era.</h2>
        </div>
        <div className="md:col-span-7">
          <p className="text-ink" style={{ fontSize: "clamp(1.05rem, 1.5vw, 1.35rem)", lineHeight: 1.55 }}>
            I went looking at the best builders on the Gold Coast and Resolve kept stopping me. Neu
            Burleigh, Villa Franco, the Lowry Farmhouse, a boutique builder with eleven Master Builders
            wins. Then I opened the website and felt the drop. It&rsquo;s static pages and an
            image-for-a-logo where it should be your homes filling the screen. For a builder at your
      ...
      <Reveal as="section" section className="home-section py-24 md:py-36 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-5" aria-label="The demo">
        ...
        <div className="md:col-span-7">
          <p className="text-ink" style={{ fontSize: "clamp(1.05rem, 1.5vw, 1.35rem)", lineHeight: 1.55 }}>
            ...
            projects gallery you can get lost scrolling, and an about page with room for the boutique
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
          <div className="border-t border-line pt-5">
            ...
            <p className="text-ink-soft" style={{ fontSize: "clamp(1rem, 1.4vw, 1.2rem)", lineHeight: 1.55 }}>
              You&rsquo;ve got beautiful photography and a real point of difference, the boutique,
              owner-led, never-compromise approach. That&rsquo;s the kind of thing you weave through a
              whole site, not bury on an about page. I can already picture it, and I&rsquo;d love the
              chance to tell it properly.
            </p>
          </div>
          <div className="border-t border-line pt-5">
            <h3 className="mono-heading text-ink mb-3">The logo</h3>
            <p className="text-ink-soft" style={{ fontSize: "clamp(1rem, 1.4vw, 1.2rem)", lineHeight: 1.55 }}>
              I&rsquo;ve kept your mark on the demo so it still feels like you, but it&rsquo;s a flat
              image file that could be redrawn as a crisp vector. A rebrand isn&rsquo;t essential, but
